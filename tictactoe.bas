'ЧТОБЫ УДАЛИТЬ ВСЕ КОММЕНТАРИИ ДЛЯ ПОКАЗА ПРЕПОДУ:
'открыть Visual Studio Code / Notepad++
'нажать Ctrl + H
'   в Notepad++: в разделе "Search Mode" выбрать режим "Regular expression", убрать галочку ". matches newline" если стоит
'   в Visual Studio Code: нажать комбинацию клавиш Alt + R или значок .* ("Use Regular Expression")
'в первое поле ввести выражение: "'.*" (без кавычек)
'второе поле оставить пустым (удалить если там что-то есть)
'нажать "Replace All" (в Visual Studio Code можно нажать комбинацию клавиш Ctrl + Alt + Enter)
